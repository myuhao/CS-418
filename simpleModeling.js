...
function yPlaneFromSubDivision(n, minZ, maxZ, minX, maxX, vertexArray, y) {
    var numT = 0;

    var va = vec4.fromValues(minX,y,minZ,0);
    var vb = vec4.fromValues(maxX,y,minZ,0);
    var vc = vec4.fromValues(maxX,y,maxZ,0);
    var vd = vec4.fromValues(minX,y,maxZ,0);
...
function xPlaneFromSubDivision(n, minZ, maxZ, minY, maxY, vertexArray,x) {
    var numT = 0;

    var va = vec4.fromValues(x,minY,minZ,0);
    var vb = vec4.fromValues(x,maxY,minZ,0);
    var vc = vec4.fromValues(x,maxY,maxZ,0);
    var vd = vec4.fromValues(x,minY,maxZ,0);
...
function zPlaneFromSubDivision(n, minX, maxX, minY, maxY, vertexArray,z) {
    var numT = 0;

    var va = vec4.fromValues(minX,minY,z,0);
    var vb = vec4.fromValues(minX,maxY,z,0);
    var vc = vec4.fromValues(maxX,maxY,z,0);
    var vd = vec4.fromValues(maxX,minY,z,0);
